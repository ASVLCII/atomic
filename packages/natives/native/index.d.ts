 ...
 */
export declare const __napiBindingTarget: 'native' | 'wasm32-wasi' | 'wasm32-wasip1' | undefined
...
export type AdmissionRefusalKind = 'depthExceeded' | 'capacityExhausted' | 'dispatchGuardBusy' | 'invalidCwd' | 'unknownAgent' | 'terminalChild'
...
export type CommandOutputSink = 'file-spool' | 'drained'
