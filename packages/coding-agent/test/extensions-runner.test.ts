...
import "./extensions-runner/project-trust.suite.ts";
import "./extensions-runner/shortcut-conflicts.suite.ts";
...
import "./extensions-runner/boundary-chaining.suite.ts";
