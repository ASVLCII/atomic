...
- If Atomic cannot open the authorization browser, use the manual URL when shown. Sensitive authorization URLs are omitted from errors; check your default browser and retry `/mcp-auth my-server`.
