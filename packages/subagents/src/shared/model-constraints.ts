...
import { THINKING_LEVELS } from "./model-info.js";
...
export const ModelConstraintsSchema = Type.Object(
	...
	},
	{
		...
		description:
			"Hard constraints for auto selection and execution fallback. Applicable agent and call constraints must all hold; concrete model calls keep existing behavior.",
	},
);
...
/** Every applicable declaration must hold; a call never widens an agent restriction. */
