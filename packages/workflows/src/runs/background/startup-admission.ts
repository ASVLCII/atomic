...
import { type DetachedAccepted, type DetachedRunOpts, runDetached } from "./runner.js";
...
export interface WorkflowStartupObserver {
	...
	readonly onRawSettled: (ok: boolean, result: RunResult | undefined, error: unknown | undefined) => void;
}

/** Resolve startup readiness separately from later workflow-body settlement. */
export function createWorkflowStartupObserver(beforeReady?: () => void): WorkflowStartupObserver {
