...
export function hasStageInputAnswerContent(answer: StageInputAnswer): boolean {
	return answer.text !== undefined || answer.optionLabels !== undefined || answer.raw !== undefined;
}
...
function buildResult(questions: readonly StageInputQuestion[], answer: StageInputAnswer): unknown {
