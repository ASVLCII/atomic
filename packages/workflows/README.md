...
{
  "name": "workflow",
  "description": "Route neutral task state to a registered workflow or none. Return routerDecision and estimatedDuration; validate selected inputs before admission. Explicit commands and authored composition bypass model-tool routing.",
  "parameters": {
