...
export const E2E_VERIFICATION_GUIDANCE = [
  ...
  "For web or frontend flows, including frontend changes whose correctness depends on backend/API behavior, use the agent-browser skill or delegate with `skill: \"agent-browser\"`; capture snapshot, screenshot, DOM, or network evidence suited to the objective.",
