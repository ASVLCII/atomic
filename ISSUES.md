...
- Default child capability inheritance remains E; service/global isolation remains G; packed export/type closure remains H. D stage fixtures explicitly disable other builtin families. Resolved D routing/rebind/questionnaire/host-parity gaps are recorded in `docs/sdk-parity-slice-d.md`, not retained here as open issues.
