...
| 43 | `b0864a66` | fix(coding-agent): preserve eval run diagnostics | **not applicable** | `packages/evals/src/{extensions.eval,pi-harness}.ts` (`…commit-paths.txt:216-219`). Atomic does not ship upstream's Vitest `packages/evals`. |
